...
export const taskConfirmationNotification = async (options: {
  email: string;
  user: any;
}) => {
                ...
                >
                  ...
                  >
                    ...
                    <tr>
                      ...
                      <div style="text-align: center">
                        <span style="font-size: 16px">${user.profile.firstName} ${user.profile.lastName} has completed the task assigned to him click the button below to view the details</span
                          >
                      </div><br />
                        <p
                          style="
                      ...
                      >
                        <tr>
                          <td colspan="2">
                            <div style="text-align: center">
                            <a
                                href="${config.datasite.urlClient}/tasks"                           
                                style="
  ...
  await sendEmail({
    ...
    to: [email],
    subject: `${config.datasite.name} - User Task Confirmation`,
    html: output,
  });
};
