...
export const authPasswordResetMail = async (options: {
  ...
  const { email, tokenVerify } = { ...options };
  const output = `
  ...
  width:100%" href="${config.datasite.urlClient}/reset-password/update${tokenVerify}">Reset Password</a>
  </td>
  </tr>
  </table><br/><br/>
  ...
  <a href="${config.datasite.urlClient}/reset-password/${tokenVerify}" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">
  ${config.datasite.urlClient}/reset-password/${tokenVerify}
  </a></span></p>
