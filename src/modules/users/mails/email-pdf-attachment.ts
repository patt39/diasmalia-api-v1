...
export const emailPDFAttachment = async (options: {
  ...
  const { email, filename, content } = options;
  const output = `
  ...
  <h6 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;"> ${config.datasite.name}</h6>

  <span style="font-size:16px">It was a pleasure making bussiness with you please view a copy of your reciept in attachment thanks </span><br/><br/>
